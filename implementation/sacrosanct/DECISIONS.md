...
*(Numbering collision, resolved at merge: this entry was allocated **D-038** on `archdisc`, but that number had already been taken by the ten-primitives entry above — itself renumbered out of a D-033 collision. It is renumbered **D-040** here. Any comment in the tree that cites "D-038" for the SURFACE value kind refers to THIS entry.)*
