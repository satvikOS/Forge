...
export const STANDARDS_CATALOG = {
  ...
  Automotive: {
    ...
    'Engine Hood':               { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoEngineHood' },
    'Front Fender':              { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoFrontFender' },
    'Sleeper Cab Extension':     { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoSleeperCabExtension' },
    'Air Horn':                  { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoAirHorn' },
    'Fifth Wheel Plate':         { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoFifthWheelPlate' },
    'Trailer King-Pin Plate':    { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoTrailerKingPinPlate' },
    'Trailer Body':              { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoTrailerBody' },
    'Trailer Floor':             { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoTrailerFloor' },
    'Trailer Roof':              { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoTrailerRoof' },
    'Trailer Side Panel':        { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoTrailerSidePanel' },
    'Trailer Rear Door':         { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoTrailerRearDoor' },
    'Mud Guard Rear':            { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoMudGuardRear' },
    'Side Step Light':           { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoSideStepLight' },
    'Aero Roof Fairing':         { standard: 'Volvo FH ref', sizes: ['stock'], table: { stock: {} }, units: 'mm', builderKey: 'volvoAeroRoofFairing' },
  },
  Bearings: {
