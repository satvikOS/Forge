    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'v12real', label: 'Mercedes M120 V12 real build IN VIEWPORT + 3 mesh sims…', slice: 'PUSH-26' },
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'windturbine', label: 'Wind turbine (Betz / actuator-disc)…', slice: 'Forge-315' },
        ],
      },
      {
        label: 'Three-phase',
