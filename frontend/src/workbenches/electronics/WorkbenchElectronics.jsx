...
function WorkbenchElectronics() {
    return (
        <>
            ...
            <div className="workbench-ribbon-placeholder" data-archdisc-ribbon-placeholder="electronics">
                <div className="workbench-ribbon-placeholder-tabs">
                    <span className="workbench-ribbon-placeholder-tab">Electronics &amp; Robotics</span>
                </div>
                <div className="workbench-ribbon-placeholder-body">
                    Component · Trace · Via · Route · Polygon · Measure · DRC (placeholder ribbon)
                </div>
            </div>
