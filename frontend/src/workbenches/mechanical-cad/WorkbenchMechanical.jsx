    ...
    surface: {
        ...
        sections: [
            ...
            { header: 'Modify', items: [
                ...
                'Thicken', 'Subdivide Surface', 'Catmull-Clark Subdivide', 'Retopo Surface', 'NURBS Patch', 'Refine NURBS', 'Elevate NURBS', 'NURBS Curvature', 'Sweep Tortuous', 'Loft Tangent', 'Stitch Faces', 'Convergent Solid', 'Knit Surface', 'Flatten', 'Deform Surface'
            ]},
