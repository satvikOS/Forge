  ...
  part: {
    ...
    groups: [
      ...
      { label: 'Sculpt', tools: [
        ...
        { name: 'Sculpt I-Beam', icon: 'Ⅰ', key: 'part' },
        ...
        { name: 'Sculpt Cone Primitive', icon: '◮', key: 'part' },
        { name: 'Sculpt Drilled Flange', icon: '✱', key: 'part' },
        { name: 'Sculpt L-Bracket', icon: '⌐', key: 'part' },
        { name: 'Sculpt T-Profile', icon: 'Ƭ', key: 'part' },
        { name: 'Sculpt U-Channel', icon: 'U', key: 'part' },
        { name: 'Sculpt Hex Block', icon: '⬣', key: 'part' },
        { name: 'Sculpt Square Tube', icon: '⬜', key: 'part' },
        ...
        { name: 'Sculpt Spool', icon: '⌅', key: 'part' },
        { name: 'Sculpt Hex Nut', icon: '⬢', key: 'part' },
        { name: 'Sculpt Washer', icon: '◍', key: 'part' },
        { name: 'Sculpt Filleted Box', icon: '◖', key: 'part' },
        { name: 'Sculpt Chamfered Box', icon: '◐', key: 'part' },
        ...
        { name: 'Sculpt Trapezoid Prism', icon: '⏢', key: 'part' },
        { name: 'Sculpt Cross Prism', icon: '✛', key: 'part' },
        { name: 'Sculpt Star Prism', icon: '★', key: 'part' },
        { name: 'Sculpt Lozenge Prism', icon: '◖', key: 'part' },
        { name: 'Sculpt D-Shape Prism', icon: 'Ⓓ', key: 'part' },
        { name: 'Sculpt Half-Cylinder', icon: '◐', key: 'part' },
        ...
        { name: 'Sculpt Tooling Split', icon: '⫶', key: 'part' },
        { name: 'Sculpt Structural Member', icon: 'Ⅰ', key: 'part' },
        ...
        { name: 'Sculpt Class-A Analyze', icon: '🌈', key: 'part' },
        ...
        { name: 'Sculpt Convergent Solid', icon: '▲', key: 'part' },
        { name: 'Sculpt Loop Subdivision', icon: '⌬', key: 'part' },
        { name: 'Sculpt Clash Detection', icon: '⊗', key: 'part' },
        ...
        { name: 'Sculpt Trimmed NURBS', icon: '◫', key: 'part' },
        { name: 'Sculpt Weld Bead', icon: '⚡', key: 'part' },
        { name: 'Sculpt Gusset', icon: '◢', key: 'part' },
        { name: 'Sculpt Trim Members', icon: '✂', key: 'part' },
        ...
        { name: 'Sculpt Full Pipeline Demo', icon: '★', key: 'part' },
        ...
        { name: 'Sculpt Wing', icon: '⪼', key: 'part' },
