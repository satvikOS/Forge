...
// Forge vendoring: Base/Console.h and FCConfig.h come from FreeCAD's base
// runtime. We replace Base::Console / Base::TimeElapsed with minimal stand-ins
// (see forge_planegcs_stub.h) so the planegcs solver compiles standalone.
#include "forge_planegcs_stub.h"
