...
void runAll() {
    ...
    // ============================================================ DEFER CONTROLS
    {
        ...
        ok(forge::occtthicken::thickenShell(lateral, T).IsNull(),
           "defer(a) : a CURVED face is DECLINED");
        okReason("a face is not a Geom_Plane", "defer(a)");
    }
    {
