...
// MODIFIED for libforge_expr (2026-09-15) from FreeCAD src/Base/Unit.h at commit
// 0a45a0a008d4af7a85601016c5ab31bd26c25b22. See MODIFICATIONS.md:
//   * namespace Base -> forge::expr; BaseExport -> FORGE_EXPR_EXPORT
//   * FCGlobal.h and Base/Exception.h replaced by forge_expr/Exception.h
//   * everything else -- the eight base dimensions, the exponent range check and
//     the named unit table -- is upstream's.
...
class FORGE_EXPR_EXPORT Unit final
{
public:
    Unit() = default;
