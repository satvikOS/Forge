...
#   3. mutation proof — SR-3 requires showing each gate CAN fail. FORTY-ONE
...
# exit 0. That wrapper also pins the mutation count at an EXACT 41, so adding or
...
run_gate forge_desktop_click_gate 1 2 3 4 5 6 7 8 9
