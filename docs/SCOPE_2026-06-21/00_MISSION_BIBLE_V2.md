...
- **Pillar D — P-1 / Prometheus eAGI capability** (`bulk_synth_eagi.py`): three primitives × six cognition levels + outcome-of-decision pairs + flagship workflows (§5).
